...
export default function AdminInvoiceItem(props) {
    ...
    /**Xác nhận đặt hàng */
    const handleConfirm = () => {
        axios.post('/order/xacnhandathang', { id: item._id, tongtien: props.tongtien })
            .then(res => {
            ...
            <div className='admin-invoice__row admin-invoice__row--top'>
                <div className='admin-invoice__button--div'>
                    <div className='admin-invoice__button'>
                        <div className='button' onClick={handleConfirm}>Xác nhận</div>
                        <div className='button admin-invoice__button--gray' onClick={handleCancer}>Hủy</div>
                    </div>
                </div>
            </div>
        </div>
