        ...
        <div className='admin'>
            ...
            <div className="admin__header">
                  ...
                  <div className="admin__header-logo">
                   <img src='https://png.pngtree.com/png-clipart/20211026/original/pngtree-simple-coffee-elemental-design-free-logo-design-template-png-image_3597680.png' className="admin__img-logo" />
                  ...
                  <div className="admin__header-infomation">     
                        ...
                        <div className='admin__avatar'>
                                 <img src="https://mondaycareer.com/wp-content/uploads/2020/11/%E1%BA%A3nh-avatar-%C4%91%E1%BA%B9p-c%C3%B4-g%C3%A1i-%C4%91eo-k%C3%ADnh.jpg" className="admin__avatar-image"/>
                        </div>
                              {/* Manage Infomation admin */}
                        <div className="admin__infomation"><i class="fa-solid fa-angle-down"></i></div>
              </div>
